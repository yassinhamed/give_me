...
class _MobileVerificationBottomSheetWidgetState extends State<MobileVerificationBottomSheetWidget> {
 ...
 /* verifyPhoneNumber()async{
    ...
    print('------------------\nThe Code was sent to the user');
        String smsCode = smsSent;
              ...
              children: <Widget>[
                Column(
                  children: <Widget>[
                    ...
                    errorMessage == null
                        ? Text(
                        "تم إرسال رمز التأكيد إلى رقم الهاتف",
                ...
                SizedBox(height: 15),
                Text(
                  "تم إرسال SMS إلى" + " " +widget.user.phone,
                ...
                BlockButtonWidget(
                  onPressed: () async {
                    ...
                    final PhoneAuthCredential credential = PhoneAuthProvider.credential(verificationId: currentUser.value.verificationId, smsCode: smsSent);
