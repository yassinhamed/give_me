                    ...
                    child: Column(
                      children: <Widget>[
                        new TextFormField(
                          ...
                          decoration: getInputDecoration(hintText: '4242 4242 4242 4242', labelText:"رقم"),
                          ...
                          onSaved: (input) => widget.creditCard.number = input.trim(),
                        ),
                        new TextFormField(
                            style: TextStyle(color: Theme.of(context).hintColor),
                            keyboardType: TextInputType.text,
                            decoration: getInputDecoration(hintText: 'mm/yy', labelText: "تاريخ الانتهاء"),
                        ...
                        new TextFormField(
                          style: TextStyle(color: Theme.of(context).hintColor),
                          keyboardType: TextInputType.number,
                          decoration: getInputDecoration(hintText: '253', labelText: "رمز التحقق من البطاقة"),
                          ...
                          onSaved: (input) => widget.creditCard.cvc = input.trim(),
                        ),
                      ],
                    ),
                  ),
